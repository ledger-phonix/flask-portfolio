...
def get_bot_response(user_question):
    ...
    system_instruction = (
        "You are Talha's personal AI portfolio helper. Your answers should be in plain text no extra * should include.  "
        "You must ONLY answer questions based on the provided context document below. You tone can be informal some times you can be friendly with the users. "
    ...
    try:
        ...
        return f"Sorry, I am having trouble connecting right now or qouta is exceed!"